...
# source https://bell-sw.com/pages/downloads/
ARG ORACLEJAVAJRE_URL=https://download.bell-sw.com/java/8u282+8/bellsoft-jdk8u282+8-linux-amd64.tar.gz
...
RUN \
    ...
    mkdir /opt/jre && \
    curl -# -L -H "Cookie: oraclelicense=accept-securebackup-cookie" ${ORACLEJAVAJRE_URL} | tar -xz --strip 2 -C /opt/jre jdk1.8.0_282/jre && \
